...
# Define the JSON response you want to return.
# You can change this dictionary to whatever you need.
...
async def mock_token():
    """
    A POST endpoint that returns a predefined JSON response.
    """
    # Return the custom JSON response.
    # FastAPI will automatically serialize this dict into a JSON string.
    return {}
...
if __name__ == "__main__":
    ...
    It will run on host 0.0.0.0 (accessible from your network)
    and on port 8081.
    """
